 ...
 */
@Component
public class MilitarySummaryActiveDutyAdapterServerSecuritySeeder extends AbstractCufSecuritySeeder {
    ...
    protected List<Class<? extends Dio<?>>> getDiosToSeed() {
        ...
        diosToSeed.add(MilitarySummaryActiveDutyAdapterDio.class);
        return diosToSeed;
    }
